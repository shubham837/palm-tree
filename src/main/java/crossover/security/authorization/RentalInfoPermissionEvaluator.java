 ...
 */
public class RentalInfoPermissionEvaluator implements PermissionEvaluator {
    private static final Logger LOGGER = LoggerFactory.getLogger(RentalInfoPermissionEvaluator.class);
